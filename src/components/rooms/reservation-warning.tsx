...
export default function ReservationWarning({ room }: ReservationWarningProps) {
  ...
  return (
    <div className='mt-3 rounded-xl bg-slate-800/60 px-3 pb-4 pt-2'>
      <h1 className='mt-2 text-sm text-primary-300'>
      ...
      <h2 className='mb-2 mt-4 text-xs text-primary-300'>تاریخ‌های رزرو شده شما:</h2>
